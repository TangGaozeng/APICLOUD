(function (window, undefined) {
    "use strict";
    var deleteMemberDialog = function () {
    };
    deleteMemberDialog.prototype = {
        params: {
            msg: "",
            buttons: ["取消", "确定"]
        },
        show: function (params, callback) {
            ...
            var buttonsHTML =
                ...
                '<div class="aui-dialog-btn" tapmode button-index="1">' + "确定" + "</div>";
    ...
    window.deleteMemberDialog = deleteMemberDialog;
})(window, undefined);